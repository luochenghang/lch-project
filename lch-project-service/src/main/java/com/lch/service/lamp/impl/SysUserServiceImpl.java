...
public class SysUserServiceImpl extends DataService<SysUserRepo, SysUser> implements SysUserService {
	...
	@Override
	@Transactional(readOnly = false)
	public int updLoginNum(Long id) throws ServiceException {
		return repo.updLoginNum(id);
	}
