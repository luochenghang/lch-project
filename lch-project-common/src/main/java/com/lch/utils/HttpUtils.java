...
public class HttpUtils {
	 ...
	 * @param msg
	 */
	public static void onAccessDenied(HttpServletResponse response, Integer code, String msg) {
		Map<String, Object> map = new HashMap<>();
		map.put("code", code);
		map.put("msg", msg);
		onAccessDenied(response, map);
	}
	 ...
	 * @throws Exception
	 */
	public static void onAccessDenied(HttpServletResponse response, Map<String, Object> map) {
		PrintWriter out = null;
		try {
			response.setCharacterEncoding("UTF-8");
			response.setContentType("application/json");
			out = response.getWriter();
			out.println(JsonUtils.getInstance().toJson(map));
		}
		catch (Exception e) {
		}
		finally {
