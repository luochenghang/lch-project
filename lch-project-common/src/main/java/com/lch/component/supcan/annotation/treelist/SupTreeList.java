package com.lch.component.supcan.annotation.treelist;
...
import com.lch.component.supcan.annotation.common.fonts.SupFont;
import com.lch.component.supcan.annotation.common.properties.SupProperties;
import com.lch.component.supcan.annotation.treelist.cols.SupGroup;

/**
 * 硕正TreeList注解
 * @author Jun
 * @date 2019年5月29日 下午6:28:17
 * @see 在类上添加注解，应用实例：
